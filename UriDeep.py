...
DESCRIPTION = ('UriDeep: System based on the similarity of the characters unicode by'
...
def getArgs():
    ...
    parser.add_argument('-l', '--light', action='store_true', help='Use the light table of confusables')
